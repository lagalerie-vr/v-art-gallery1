...
class Merlin {
	...
	/**
	 * The url of the button leading to home preview during the finish step of the wizzard.
	 *
	...
	function serano_child_enqueue_styles() {

		\$content_style = 'serano-content';
		\$showcase_style = 'serano-showcase';
		\$portfolio_style = 'serano-portfolio';
		\$blog_style = 'serano-blog';
		\$shortcodes_style = 'serano-shortcodes';
		\$assets_style = 'serano-assets';
		\$wp_style = 'serano-style-wp';
		\$page_builders_style = 'serano-page-builders';
	...
	add_action( 'wp_enqueue_scripts', 'serano_child_enqueue_styles' );
	...
	/**
	 * Replacement for the deprecated WordPress get_page_by_title function
	 */
