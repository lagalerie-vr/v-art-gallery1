			...
			<div id="main-content">
				...
				<div id="itemsWrapperLinks">
					<div id="itemsWrapper" class="<?php echo sanitize_html_class( $serano_portfolio_thumb_to_fullscreen ); ?> <?php echo sanitize_html_class( $serano_portfolio_thumb_to_fullscreen_webgl_type ); ?>">
						...
						<!-- ClaPat Slider -->
						<div class="clapat-slider-wrapper showcase-carousel<?php if( !serano_get_theme_options('clapat_serano_enable_ajax') ) { echo ' thumb-no-ajax'; } ?>">
							<div class="clapat-slider">
								...
								?>
									...
									<div class="clapat-slide" data-color="<?php echo esc_attr( $serano_project_nav_color ); ?>">
										<div class="slide-inner trigger-item <?php echo sanitize_html_class( $serano_change_header ); ?>">
											<div class="img-mask">
							...
							<div class="progress-info fadeout-element">
								<div class="progress-info-fill"><?php echo wp_kses( serano_get_theme_options('clapat_serano_showcase_scroll_drag_caption'), 'serano_allowed_html') ?></div>
								<div class="progress-info-fill-2"><?php echo wp_kses( serano_get_theme_options('clapat_serano_showcase_scroll_drag_caption'), 'serano_allowed_html') ?></div>
							</div>
