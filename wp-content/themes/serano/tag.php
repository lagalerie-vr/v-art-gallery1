		...
		<div id="hero">
			<div id="hero-styles">
				<div id="hero-caption" class="content-full-width parallax-scroll-caption inline-title">
					<div class="inner">
						<h1 class="hero-title caption-timeline"><span><?php single_tag_title('', true); ?></span></h1>
						<h5 class="hero-subtitle caption-timeline"><span><?php echo esc_html__( 'Tag Results', 'serano'); ?></span></h5>
			...
			<div id="blog-page-content">
				...
				<?php 
					...
					if( have_posts() ){
						...
						echo '<h4 class="search_results">' . esc_html__('No posts found with this tag', 'serano') . '</h4>';
					}
				?>
