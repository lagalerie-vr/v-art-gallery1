(function() {
    tinymce.create('tinymce.plugins.SeranoCoreShortcodes', {
        init : function(ed, url) {
            ed.addButton('clapat_shortcode_button', {
				type: 'menubutton',
				text: 'C',
				title: 'Insert Serano Shortcode',
                icon: false,
		...
		getInfo: function () {
            return {
				...
				longname: 'Serano Shortcodes',
                author: 'Serano Studio',
                authorurl: 'http://themeforest.net/user/clapat/',
                infourl: 'http://clapat-themes.com/wordpress/serano/',
                version: "1.0"
            }
        }
    });
    // Register plugin
    tinymce.PluginManager.add( 'SeranoCoreShortcodes', tinymce.plugins.SeranoCoreShortcodes );
})();