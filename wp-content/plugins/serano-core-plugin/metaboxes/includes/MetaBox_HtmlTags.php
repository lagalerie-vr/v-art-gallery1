...
namespace Serano\Core\Metaboxes;
...
class HtmlTags extends Html {
	...
	public static function media( $post = null, $name = "", $content = "", $echo = false ){
		...
		$return .= __('Upload', 'serano_core_plugin_text_domain');
		$return .= '</a>';
		$return .= '<a class="delete-clapat-metabox-img button-secondary" ';
		$return .= 'href="#">';
		$return .= __('Remove', 'serano_core_plugin_text_domain');
		$return .= '</a>';
		$return .= '</p>';
	...
	public static function gallery( $post = null, $name = "", $content = "", $echo = false ){
		...
		$return .= '<input title="' . esc_html__( 'Manage gallery', 'serano_core_plugin_text_domain' ) .'" type="button" class="manage-clapat-metabox-gallery button-primary" value="' . esc_html__( 'Manage gallery', 'serano_core_plugin_text_domain' ) . '" />';
		$return .= '<input title="' . esc_html__( 'Empty gallery', 'serano_core_plugin_text_domain' ) .'" type="button" class="empty-clapat-metabox-gallery button-secondary" value="' . esc_html__( 'Empty gallery', 'serano_core_plugin_text_domain' ) . '" />';
		$return .= '</div>';
