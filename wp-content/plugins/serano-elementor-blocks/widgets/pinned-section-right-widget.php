 ...
 * @since 1.0.0
 */
class Elementor_Serano_Pinned_Section_Right_Widget extends \Elementor\Widget_Base {
	...
	public function get_name() {
		return 'serano_pinned_section_right';
	}
	...
	public function get_title() {
		return __( 'Right Pinned Section', 'serano-elementor-widgets' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'pinned_text',
			[
				'label' => __( 'Right Pinned Text (HTML allowed)', 'serano-elementor-widgets' ),
				'type' => \Elementor\Controls_Manager::CODE,
				'language' => 'html',
				'rows' => 20,
			]
